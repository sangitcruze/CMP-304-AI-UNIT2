...
from keras.preprocessing.image import load_img, img_to_array #converts images to an array
...
from keras.optimizers import Adam,SGD,RMSprop #optimizer is required for compiling a Keras model
...
rom keras.optimizers import Adam,SGD,RMSprop
